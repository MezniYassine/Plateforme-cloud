      ...
      next: (data) => {
        ...
        const paasItems: MyService[] = (data || []).map((db: any) => {
          ...
          return {
            ...
            bg: isRedis ? 'var(--red-light, #fee2e2)' : (isMongo ? 'var(--green-light, #dcfce7)' : 'var(--orange-light, #dbeafe)'),
            color: isRedis ? 'var(--red, #ef4444)' : (isMongo ? 'var(--green, #22c55e)' : 'var(--orange, #3b82f6)'),
